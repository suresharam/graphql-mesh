...
export type QueryResolvers<ContextType = MeshContext, ParentType extends ResolversParentTypes['Query'] = ResolversParentTypes['Query']> = ResolversObject<{
  findAdminDivisionsUsingGET?: Resolver<Maybe<ResolversTypes['findAdminDivisionsUsingGET_response']>, ParentType, ContextType, RequireFields<QueryfindAdminDivisionsUsingGETArgs, 'distanceUnit' | 'namePrefixDefaultLangResults' | 'hateoasMode' | 'limit' | 'includeDeleted'>>;
  getAdminDivisionUsingGET?: Resolver<Maybe<ResolversTypes['getAdminDivisionUsingGET_response']>, ParentType, ContextType, RequireFields<QuerygetAdminDivisionUsingGETArgs, 'divisionId'>>;
  findCitiesNearAdminDivisionUsingGET?: Resolver<Maybe<ResolversTypes['findCitiesNearAdminDivisionUsingGET_response']>, ParentType, ContextType, RequireFields<QueryfindCitiesNearAdminDivisionUsingGETArgs, 'divisionId' | 'distanceUnit' | 'namePrefixDefaultLangResults' | 'hateoasMode' | 'limit' | 'includeDeleted'>>;
  findDivisionsNearAdminDivisionUsingGET?: Resolver<Maybe<ResolversTypes['findDivisionsNearAdminDivisionUsingGET_response']>, ParentType, ContextType, RequireFields<QueryfindDivisionsNearAdminDivisionUsingGETArgs, 'divisionId' | 'distanceUnit' | 'namePrefixDefaultLangResults' | 'hateoasMode' | 'limit' | 'includeDeleted'>>;
  findPlacesNearAdminDivisionUsingGET?: Resolver<Maybe<ResolversTypes['findPlacesNearAdminDivisionUsingGET_response']>, ParentType, ContextType, RequireFields<QueryfindPlacesNearAdminDivisionUsingGETArgs, 'divisionId' | 'distanceUnit' | 'namePrefixDefaultLangResults' | 'hateoasMode' | 'limit' | 'includeDeleted'>>;
  findCitiesUsingGET?: Resolver<Maybe<ResolversTypes['findCitiesUsingGET_response']>, ParentType, ContextType, RequireFields<QueryfindCitiesUsingGETArgs, 'distanceUnit' | 'namePrefixDefaultLangResults' | 'hateoasMode' | 'limit' | 'includeDeleted'>>;
  findCitiesNearCityUsingGET?: Resolver<Maybe<ResolversTypes['findCitiesNearCityUsingGET_response']>, ParentType, ContextType, RequireFields<QueryfindCitiesNearCityUsingGETArgs, 'cityId' | 'distanceUnit' | 'namePrefixDefaultLangResults' | 'hateoasMode' | 'limit' | 'includeDeleted'>>;
  findDivisionsNearCityUsingGET?: Resolver<Maybe<ResolversTypes['findDivisionsNearCityUsingGET_response']>, ParentType, ContextType, RequireFields<QueryfindDivisionsNearCityUsingGETArgs, 'cityId' | 'distanceUnit' | 'namePrefixDefaultLangResults' | 'hateoasMode' | 'limit' | 'includeDeleted'>>;
  findPlacesNearCityUsingGET?: Resolver<Maybe<ResolversTypes['findPlacesNearCityUsingGET_response']>, ParentType, ContextType, RequireFields<QueryfindPlacesNearCityUsingGETArgs, 'cityId' | 'distanceUnit' | 'namePrefixDefaultLangResults' | 'hateoasMode' | 'limit' | 'includeDeleted'>>;
  getCityUsingGET?: Resolver<Maybe<ResolversTypes['getCityUsingGET_response']>, ParentType, ContextType, RequireFields<QuerygetCityUsingGETArgs, 'cityId'>>;
  getCityDistanceUsingGET?: Resolver<Maybe<ResolversTypes['getCityDistanceUsingGET_response']>, ParentType, ContextType, RequireFields<QuerygetCityDistanceUsingGETArgs, 'cityId' | 'toCityId' | 'distanceUnit'>>;
  getCityDateTimeUsingGET?: Resolver<Maybe<ResolversTypes['getCityDateTimeUsingGET_response']>, ParentType, ContextType, RequireFields<QuerygetCityDateTimeUsingGETArgs, 'cityId'>>;
  getCityLocatedInUsingGET?: Resolver<Maybe<ResolversTypes['getCityLocatedInUsingGET_response']>, ParentType, ContextType, RequireFields<QuerygetCityLocatedInUsingGETArgs, 'cityId'>>;
  getCityTimeUsingGET?: Resolver<Maybe<ResolversTypes['getCityTimeUsingGET_response']>, ParentType, ContextType, RequireFields<QuerygetCityTimeUsingGETArgs, 'cityId'>>;
  getCountriesUsingGET?: Resolver<Maybe<ResolversTypes['getCountriesUsingGET_response']>, ParentType, ContextType, RequireFields<QuerygetCountriesUsingGETArgs, 'namePrefixDefaultLangResults' | 'hateoasMode' | 'limit'>>;
  getCountryUsingGET?: Resolver<Maybe<ResolversTypes['getCountryUsingGET_response']>, ParentType, ContextType, RequireFields<QuerygetCountryUsingGETArgs, 'countryId'>>;
  findCountryPlacesUsingGET?: Resolver<Maybe<ResolversTypes['findCountryPlacesUsingGET_response']>, ParentType, ContextType, RequireFields<QueryfindCountryPlacesUsingGETArgs, 'countryId' | 'namePrefixDefaultLangResults' | 'hateoasMode' | 'limit' | 'includeDeleted'>>;
  getRegionsUsingGET?: Resolver<Maybe<ResolversTypes['getRegionsUsingGET_response']>, ParentType, ContextType, RequireFields<QuerygetRegionsUsingGETArgs, 'countryId' | 'namePrefixDefaultLangResults' | 'hateoasMode' | 'limit'>>;
  getRegionUsingGET?: Resolver<Maybe<ResolversTypes['getRegionUsingGET_response']>, ParentType, ContextType, RequireFields<QuerygetRegionUsingGETArgs, 'countryId' | 'regionCode'>>;
  findRegionDivisionsUsingGET?: Resolver<Maybe<ResolversTypes['findRegionDivisionsUsingGET_response']>, ParentType, ContextType, RequireFields<QueryfindRegionDivisionsUsingGETArgs, 'countryId' | 'regionCode' | 'namePrefixDefaultLangResults' | 'hateoasMode' | 'limit' | 'includeDeleted'>>;
  findRegionCitiesUsingGET?: Resolver<Maybe<ResolversTypes['findRegionCitiesUsingGET_response']>, ParentType, ContextType, RequireFields<QueryfindRegionCitiesUsingGETArgs, 'countryId' | 'regionCode' | 'namePrefixDefaultLangResults' | 'hateoasMode' | 'limit' | 'includeDeleted'>>;
  findRegionPlacesUsingGET?: Resolver<Maybe<ResolversTypes['findRegionPlacesUsingGET_response']>, ParentType, ContextType, RequireFields<QueryfindRegionPlacesUsingGETArgs, 'countryId' | 'regionCode' | 'namePrefixDefaultLangResults' | 'hateoasMode' | 'limit' | 'includeDeleted'>>;
  findCitiesNearLocationUsingGET?: Resolver<Maybe<ResolversTypes['findCitiesNearLocationUsingGET_response']>, ParentType, ContextType, RequireFields<QueryfindCitiesNearLocationUsingGETArgs, 'locationId' | 'distanceUnit' | 'namePrefixDefaultLangResults' | 'hateoasMode' | 'limit' | 'includeDeleted'>>;
  findDivisionsNearLocationUsingGET?: Resolver<Maybe<ResolversTypes['findDivisionsNearLocationUsingGET_response']>, ParentType, ContextType, RequireFields<QueryfindDivisionsNearLocationUsingGETArgs, 'locationId' | 'distanceUnit' | 'namePrefixDefaultLangResults' | 'hateoasMode' | 'limit' | 'includeDeleted'>>;
  findPlacesNearLocationUsingGET?: Resolver<Maybe<ResolversTypes['findPlacesNearLocationUsingGET_response']>, ParentType, ContextType, RequireFields<QueryfindPlacesNearLocationUsingGETArgs, 'locationId' | 'distanceUnit' | 'namePrefixDefaultLangResults' | 'hateoasMode' | 'limit' | 'includeDeleted'>>;
  findPlacesUsingGET?: Resolver<Maybe<ResolversTypes['findPlacesUsingGET_response']>, ParentType, ContextType, RequireFields<QueryfindPlacesUsingGETArgs, 'distanceUnit' | 'namePrefixDefaultLangResults' | 'hateoasMode' | 'limit' | 'includeDeleted'>>;
  findPlacesNearPlaceUsingGET?: Resolver<Maybe<ResolversTypes['findPlacesNearPlaceUsingGET_response']>, ParentType, ContextType, RequireFields<QueryfindPlacesNearPlaceUsingGETArgs, 'placeId' | 'distanceUnit' | 'namePrefixDefaultLangResults' | 'hateoasMode' | 'limit' | 'includeDeleted'>>;
  getPlaceUsingGET?: Resolver<Maybe<ResolversTypes['getPlaceUsingGET_response']>, ParentType, ContextType, RequireFields<QuerygetPlaceUsingGETArgs, 'placeId'>>;
  getPlaceDistanceUsingGET?: Resolver<Maybe<ResolversTypes['getPlaceDistanceUsingGET_response']>, ParentType, ContextType, RequireFields<QuerygetPlaceDistanceUsingGETArgs, 'placeId' | 'toPlaceId' | 'distanceUnit'>>;
  getPlaceDateTimeUsingGET?: Resolver<Maybe<ResolversTypes['getPlaceDateTimeUsingGET_response']>, ParentType, ContextType, RequireFields<QuerygetPlaceDateTimeUsingGETArgs, 'placeId'>>;
  getPlaceLocatedInUsingGET?: Resolver<Maybe<ResolversTypes['getPlaceLocatedInUsingGET_response']>, ParentType, ContextType, RequireFields<QuerygetPlaceLocatedInUsingGETArgs, 'placeId'>>;
  getPlaceTimeUsingGET?: Resolver<Maybe<ResolversTypes['getPlaceTimeUsingGET_response']>, ParentType, ContextType, RequireFields<QuerygetPlaceTimeUsingGETArgs, 'placeId'>>;
  getCurrenciesUsingGET?: Resolver<Maybe<ResolversTypes['getCurrenciesUsingGET_response']>, ParentType, ContextType, RequireFields<QuerygetCurrenciesUsingGETArgs, 'countryId' | 'hateoasMode' | 'limit'>>;
  getLanguagesUsingGET?: Resolver<Maybe<ResolversTypes['getLanguagesUsingGET_response']>, ParentType, ContextType, RequireFields<QuerygetLanguagesUsingGETArgs, 'hateoasMode' | 'limit'>>;
  getLocalesUsingGET?: Resolver<Maybe<ResolversTypes['getLocalesUsingGET_response']>, ParentType, ContextType, RequireFields<QuerygetLocalesUsingGETArgs, 'hateoasMode' | 'limit'>>;
  getTimezonesUsingGET?: Resolver<Maybe<ResolversTypes['getTimezonesUsingGET_response']>, ParentType, ContextType, RequireFields<QuerygetTimezonesUsingGETArgs, 'hateoasMode' | 'limit'>>;
  getTimeZoneUsingGET?: Resolver<Maybe<ResolversTypes['getTimeZoneUsingGET_response']>, ParentType, ContextType, RequireFields<QuerygetTimeZoneUsingGETArgs, 'zoneId'>>;
  getTimeZoneDateTimeUsingGET?: Resolver<Maybe<ResolversTypes['getTimeZoneDateTimeUsingGET_response']>, ParentType, ContextType, RequireFields<QuerygetTimeZoneDateTimeUsingGETArgs, 'zoneId'>>;
  getTimeZoneTimeUsingGET?: Resolver<Maybe<ResolversTypes['getTimeZoneTimeUsingGET_response']>, ParentType, ContextType, RequireFields<QuerygetTimeZoneTimeUsingGETArgs, 'zoneId'>>;
}>;
...
export type MeshContext = GeoDbTypes.Context & BaseMeshContext;
